...
public class Message extends SimpleEvent {
	...
	/**
	 * Message Type: COLLECTLOAD (message regarding load collect)
	 */
	public static final int MSG_COLLECTLOAD = 5;
	
	/**
	 * Message Type: LOADRESPONSE (respons message to a collect load)
	 */
	public static final int MSG_LOADRESPONSE = 6;
	...
	public static final Message makeCollectLoad(Object body) {
		return new Message(MSG_COLLECTLOAD, body);
	}
	
	public static final Message makeCollectresponse(int physicalId, int load) {
		int[] body = new int[2];
		body[0] = physicalId;
		body[1] = load;
		return new Message(MSG_LOADRESPONSE, (Object)body);
	}
	...
	public String messageTypetoString() {
		switch (type) {
			...
			case MSG_COLLECTLOAD:
				return "MSG_COLLECTLOAD";
			default:
				return "UNKNOW:" + type;
		}
	}
